    ...
    export default {
        ...
        methods: {
            swiper(e) {
                ...
                this.$refs.bgSwiperTab.scrollLeft = this.$refs.bgSwiperTab.scrollLeft - moveX + this.pageX;
        ...
        mounted() {
            this.$nextTick(() => {
                ...
                //this.$refs.bgSwiperTab.scrollLeft = 200
                //console.log(this.$refs.bgSwiperTab.scrollWidth, this.$el.offsetWidth)
